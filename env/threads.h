...
#define CEU_THREADS_CANCEL(t)       ceu_assert(pthread_cancel(t)==0, "bug found")
#if 1
...
#endif
#define CEU_THREADS_JOIN(t)         ceu_assert(pthread_join(t,NULL)==0, "bug found")
#define CEU_THREADS_MUTEX_LOCK(m)   ceu_assert(pthread_mutex_lock(m)==0, "bug found")
#define CEU_THREADS_MUTEX_UNLOCK(m) ceu_assert(pthread_mutex_unlock(m)==0, "bug found")
