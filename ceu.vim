...
syn keyword	cStatement async await break native continue do else emit end event every finalize FOREVER if input loop nothing output par pause return then until var with class global include interface free new this spawn thread sync function escape call rec recursive isr atomic
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
