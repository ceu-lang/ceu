...
-- Declarations
    ...
    , _BlockI = ( ((V'__Org'+V'_Vars_set'+EV'_Vars')+V'_Evts'+V'_Dcl_pool'+V'_Code_proto'+V'_Dcl_imp')
                    * (EK';'*K';'^0)
                + V'Dcl_mode' * K':'
                )^0
...
---------
    ...
    , __StmtS    = V'Nothing'
                 + V'__Org'
                 + V'_Vars_set' + V'_Vars' + V'_Evts' + V'_Exts'
                 + V'_Dcl_pool'
